...
class CallTest extends TestCase
{
    ...
    {
        $test->assertInstanceOf(CallTest::class, $test);
    ...
    {
        $this->container->set(CallTest::class, $this);
    ...
    public function it_should_call_static_methods()
    {
        ...
        $result = $this->container->call([CallTest::class, 'inject_and_perform_assertions_statically'], ['challenge' => 2]);
        
        $this->assertEquals(3, $result);
    
        $result = $this->container->call(CallTest::class . '::inject_and_perform_assertions_statically', ['challenge' => 3]);
    ...
    {
        $result = $this->container->call(CallTest::class . '@construct_and_perform_assertions', ['challenge' => 5]);
    ...
    public function it_should_call_bound_services_methods_with_at_sign_notation()
    {
        ...
        $result = $this->container->call(CallTest::class . '@inject_and_perform_assertions', ['challenge' => 7]);
    ...
    {
        $result = $this->container->call(CallTest::class . '@construct_and_perform_assertions', ['challenge' => 7]);
